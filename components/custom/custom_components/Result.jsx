...
const Result = () => {
  ...
  return (
    <div className='w-[80vw] h-[90vh] border  flex flex-col rounded-lg overflow-hidden shadow-lg items-center justify-start text-black text-2xl font-bold'>
        <div className='w-full h-20 flex justify-evenly items-center'><MaterialButton className='bg-stone-900' onClick={()=>setView("summary")}>Summary</MaterialButton> <MaterialButton className='bg-stone-900' onClick={()=>setView("review")}>Review</MaterialButton></div>
